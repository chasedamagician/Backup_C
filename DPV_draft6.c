...
else if (compare_Values(my_point->x, comp1) == 1 && my_frame->current_y < comp2)
{
while (my_frame->current_y < comp2)
{
my_frame->current_y = my_frame->current_y + my_pulse.value;
insert_point(my_frame);
...
else if (compare_Values(my_frame->current_y, comp2) == 1 && my_point->x > comp1)
{
while (my_point->x > comp1)
{
my_point->x = my_point->x - my_pulse.value;
...
my_frame -> current_y = my_pulse.starting_y;
while (z != 0)
{
